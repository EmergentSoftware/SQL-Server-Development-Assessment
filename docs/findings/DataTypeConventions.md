...
**Check Id:** 61 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Columns+and+Parameters+or+Variables+Used+in+JOINs+and+WHERE+Clauses+Should+Have+the+Same+Data+Type)
...
**Check Id:** 62 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Do+not+use+Deprecated+Data+Type)
...
**Check Id:** 63 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Not+Using+Semicolon+THROW)
...
**Check Id:** 64 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=An+Email+Address+Column+Must+not+Exceed+254+Characters)
...
**Check Id:** 65 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=A+URL+Column+Must+not+Exceed+2083+Characters)
...
**Check Id:** 66 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Do+not+Overuse+(n)varchar(MAX)+for+Columns)
...
**Check Id:** 67 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Use+bit+for+Boolean+Columns)
...
**Check Id:** 68 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Only+use+the+float+and+real+Data+Types+for+Scientific+Use+Cases)
...
**Check Id:** 69 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Do+not+use+the+sql_variant+Data+Type)
...
**Check Id:** 70 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Use+the+datetimeoffset+Data+Type+When+Time+Zone+Awareness+is+Needed)
...
**Check Id:** 70 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Use+the+date+Data+Type+When+Time+Values+are+not+Required+or+the+smalldatetime+Data+Type+when+Precision+of+Minute+is+Acceptable)
...
**Check Id:** 71 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Use+the+time+Data+Type+When+Date+Values+are+not+Required+or+the+smalldatetime+Data+Type+when+Precision+of+Minute+is+Acceptable)
...
**Check Id:** 72 [None yet, click here to add the issue](https://github.com/EmergentSoftware/SQL-Server-Development-Assessment/issues/new?assignees=&labels=enhancement&template=feature_request.md&title=Use+the+nvarchar+Data+Type+Instead+the+varchar+Data+Type+for+Unicode+Data)

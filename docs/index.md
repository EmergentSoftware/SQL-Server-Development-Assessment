...
You can use the link in the [results tab](../results-explanations) to navigate to the specific check details. Also, feel free to read through the sections as there might not be a check created yet to incorporate other best practices in your development.
